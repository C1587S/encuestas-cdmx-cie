"""
Django settings for encuestas cdmx cie project.
...
ADMINS = (("Admins", "info@encuestascdmx.com"),)
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = "[encuestas cdmx cie] "  # subject prefix for managers & admins
...
SESSION_COOKIE_NAME = "encuestas_cdmx_cie_ssid"
...
DATABASES = {
    ...
    "default": env.db_url(
        ...
        default="psql://{user}:{password}@{host}:{port}/{name}?sslmode={sslmode}".format(
            ...
            name=quote(env.str("DJANGO_DATABASE_NAME", default="encuestas_cdmx_cie")),
            user=quote(env.str("DJANGO_DATABASE_USER", default="encuestas_cdmx_cie")),
            password=quote(env.str("DJANGO_DATABASE_PASSWORD", default="encuestas_cdmx_cie")),
...
ROOT_URLCONF = "encuestas_cdmx_cie.urls"

WSGI_APPLICATION = "encuestas_cdmx_cie.wsgi.application"
...
# Email config
DEFAULT_FROM_EMAIL = "encuestas cdmx cie <info@encuestascdmx.com>"
SERVER_EMAIL = "encuestas cdmx cie server <server@encuestascdmx.com>"
