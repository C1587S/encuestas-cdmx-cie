...
ALLOWED_HOSTS = env.list(
    ...
    default=["office.encuestas-cdmx-cie.test.encuestascdmx.com", "encuestas-cdmx-cie.test.encuestascdmx.com"],
)

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str("RAZZLE_SITE_URL", default="https://encuestas-cdmx-cie.test.encuestascdmx.com")
DJANGO_SITE_URL = env.str(
    "RAZZLE_BACKEND_SITE_URL", default="https://office.encuestas-cdmx-cie.test.encuestascdmx.com"
)

CSRF_COOKIE_DOMAIN = env.str(
    "DJANGO_CSRF_COOKIE_DOMAIN", default=".encuestas-cdmx-cie.test.encuestascdmx.com"
)
    ...
    LOGGING["handlers"].update(
        {
            "info_log": {
                ...
                "filename": "/var/log/encuestas_cdmx_cie/info.log",
                "formatter": "default",
            },
            "error_log": {
                "level": "ERROR",
                "class": "logging.handlers.WatchedFileHandler",
                "filename": "/var/log/encuestas_cdmx_cie/error.log",
                "formatter": "default",
            },
        }
    )
...
# Enable S3 storage
DEFAULT_FILE_STORAGE = "encuestas_cdmx_cie.storages.MediaStorage"
MEDIA_ROOT = env.str("DJANGO_MEDIA_ROOT", default="")
AWS_STORAGE_BUCKET_NAME = env.str(
    "DJANGO_AWS_STORAGE_BUCKET_NAME", default="encuestas_cdmx_cie-staging"
)
