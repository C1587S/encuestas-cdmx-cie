...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["office.encuestascdmx.com", "encuestascdmx.com"]
)

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str("RAZZLE_SITE_URL", default="https://encuestascdmx.com")
DJANGO_SITE_URL = env.str("RAZZLE_BACKEND_SITE_URL", default="https://office.encuestascdmx.com")

CSRF_COOKIE_DOMAIN = env.str("DJANGO_CSRF_COOKIE_DOMAIN", default=".encuestascdmx.com")
...
AWS_STORAGE_BUCKET_NAME = env.str(
    "DJANGO_AWS_STORAGE_BUCKET_NAME", default="encuestas_cdmx_cie-production"
)
